...
//    sss.Build_base_TriangleObstacle(Point_3(7,-12,4), Point_3(7.0123,-12.0002,-4.1), Point_3(8,-12.0001,0.002));
    
    sss.Build_base_TriangleObstacle(Point_3(-7,-7,4), Point_3(-7.0123,-7.0002,-4.1), Point_3(-8,-7.0001,0.002));
    
    sss.Build_base_TriangleObstacle(Point_3(-7,-12,4), Point_3(-7.0123,-12.0002,-4.1), Point_3(-8,-12.0001,0.002));
    
//    sss.Build_base_TriangleObstacle(Point_3(15,5.00001,4), Point_3(15,5.00001,-4.002), Point_3(-4,5,3.9));
//    sss.Build_base_TriangleObstacle(Point_3(-4,5,3.9), Point_3(-4,5.0002,-4.1), Point_3(15,5.00001,-4.002));
