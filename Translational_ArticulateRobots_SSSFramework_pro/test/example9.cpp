...
//    sss.Build_base_TriangleObstacle(Point_3(7,-11,4), Point_3(7.0123,-11.0002,-4.1), Point_3(8,-11.0001,0.002));
    ...
    sss.Build_base_TriangleObstacle(Point_3(15,9.00001,4), Point_3(15,9.00001,-4.002), Point_3(1.5,9,3.9));
    sss.Build_base_TriangleObstacle(Point_3(1.5,9,3.9), Point_3(1.5,9.0002,-4.1), Point_3(15,9.00001,-4.002));
    
    sss.Build_base_TriangleObstacle(Point_3(-15,9.00001,4), Point_3(-15,9.00001,-4.002), Point_3(-1.5,9,3.9));
    sss.Build_base_TriangleObstacle(Point_3(-1.5,9,3.9), Point_3(-1.5,9.0002,-4.1), Point_3(-15,9.00001,-4.002));
    
    sss.Build_base_TriangleObstacle(Point_3(-1.5,9.0001,1.001), Point_3(0,9.00001,4.002), Point_3(1.5,9,1.05));
    sss.Build_base_TriangleObstacle(Point_3(-1.5,9.0001,-1.001), Point_3(0,9.00001,-4.002), Point_3(1.5,9,-1.05));
